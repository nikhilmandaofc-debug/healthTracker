  ...
  const handleLogin = async () => {
    ...
    try{
      ...
      if(res.ok){
        ...
        setError(data.detail || "Invalid administrator credentials");
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full mt-1 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none"
          />
        ...
        >
          {loading ? "Logging in..." : "Login to Administrator Portal"}
        </button>
